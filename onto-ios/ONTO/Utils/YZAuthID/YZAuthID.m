...
- (void)yz_showAuthIDWithDescribe:(NSString *)desc BlockState:(StateBlock)block{
    ...
    if ([context canEvaluatePolicy:LAPolicyDeviceOwnerAuthentication error:&error]||[context canEvaluatePolicy:LAPolicyDeviceOwnerAuthenticationWithBiometrics error:&error]) {
                ...
                if (@available(iOS 12.0, *)) {
                    switch (error.code) {
                        ...
                        case LAErrorUserCancel:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID/FaceID 被用户手动取消");
                        ...
                        case LAErrorUserFallback:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"用户不使用TouchID/FaceID,选择手动输入密码");
                        ...
                        case LAErrorSystemCancel:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID/FaceID 被系统取消 (如遇到来电,锁屏,按了Home键等)");
                        ...
                        case LAErrorPasscodeNotSet:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID/FaceID 无法启动,因为用户没有设置密码");
                        ...
                        case LAErrorBiometryNotEnrolled:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID/FaceID 无法启动,因为用户没有设置TouchID");
                        ...
                        case LAErrorBiometryLockout:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID 被锁定(连续多次验证TouchID/FaceID失败,系统需要用户手动输入密码)");
                        ...
                        case LAErrorAppCancel:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"当前软件被挂起并取消了授权 (如App进入了后台等)");
                        ...
                        case LAErrorInvalidContext:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"当前软件被挂起并取消了授权 (LAContext对象无效)");
                    ...
                    switch (error.code) {
                        ...
                        case LAErrorUserFallback:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"用户不使用TouchID,选择手动输入密码");
                                block(YZAuthIDStateInputPassword,error);
                            });
                        }
                            break;
                        case LAErrorSystemCancel:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID 被系统取消 (如遇到来电,锁屏,按了Home键等)");
                                block(YZAuthIDStateSystemCancel,error);
                            });
                        }
                            break;
                        case LAErrorPasscodeNotSet:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID 无法启动,因为用户没有设置密码");
                                block(YZAuthIDStatePasswordNotSet,error);
                            });
                        }
                            break;
                        case LAErrorTouchIDNotEnrolled:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID 无法启动,因为用户没有设置TouchID");
                                block(YZAuthIDStateTouchIDNotSet,error);
                            });
                        }
                            break;
                        ...
                        case LAErrorTouchIDLockout:{
                            dispatch_async(dispatch_get_main_queue(), ^{
                                DebugLog(@"TouchID 被锁定(连续多次验证TouchID失败,系统需要用户手动输入密码)");
                                block(YZAuthIDStateTouchIDLockout,error);
                            });
                        }
                            break;
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            DebugLog(@"当前设备不支持TouchID/FaceID");
