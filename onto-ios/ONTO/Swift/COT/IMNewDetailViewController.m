...
@interface IMNewDetailViewController ()
...
@implementation IMNewDetailViewController
...
-(UIView*)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section ==0) {
        ...
        image.image =[UIImage imageNamed:@"IMcard"];
        ...
        if ([self.claimContext isEqualToString:@"claim:idm_passport_authentication"]) {
        ...
        }else if ([self.claimContext isEqualToString:@"claim:idm_idcard_authentication"]){
        ...
        [btn setImage:[UIImage imageNamed:@"cotlink1"] forState:UIControlStateNormal];
        [btn setTitleColor:[UIColor colorWithHexString:@"#29A6FF"] forState:UIControlStateNormal];
        [btn setTitle:Localized(@"IdentityMindCertification") forState:UIControlStateNormal   ];
        [v2 addSubview:btn];
        [btn handleControlEvent:UIControlEventTouchUpInside withBlock:^{
            ...
            VC.introduce = [NSString stringWithFormat:@"https://info.onto.app/#/detail/%@",[ENORCN isEqualToString:@"cn"]?@"62":@"63"];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section ==0) {
        ...
        if ([cell.leftLB.text isEqualToString:@"CredentialNumber"]) {
        ...
        if (indexPath.row ==0) {
            cell.bottomLB.textColor =[UIColor colorWithHexString:@"#51C7C9"];
