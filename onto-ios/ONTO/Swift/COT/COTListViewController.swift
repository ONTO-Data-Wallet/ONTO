...
class COTListViewController: BaseViewController,UITableViewDelegate,UITableViewDataSource {
...
//        let textLabelSize = self.textSize(text:loacalkey(key: "COTNeed") , font: UIFont.systemFont(ofSize: 12, weight: .regular), maxSize: textMaxSize)
        ...
        let o1Dic = resultDic.value(forKey: "ReqContexts") as! NSDictionary
        if o1Dic.isKind(of: NSDictionary.self) && (o1Dic.value(forKey: "O1") != nil) {
//            mobileNext
            let num = o1Dic.value(forKey: "O1") as! NSArray
            if  num.count > 0 {
    ...
    @objc func toGetCert() {
        ...
        let o1Dic = resultDic.value(forKey: "ReqContexts") as! NSDictionary
        if o1Dic.isKind(of: NSDictionary.self) && (o1Dic.value(forKey: "O1") != nil) {
            let o1Arr = o1Dic.value(forKey: "O1") as! NSArray
            if o1Arr.count > 0{
                
                let cotVc = COTOListViewController()
                cotVc.resultDic = resultDic
                cotVc.certArray = o1Dic.value(forKey: "O1") as! NSArray
                cotVc.ClaimIdsArr1 = ClaimIdsArr
                cotVc.ClaimContextsArr1 = ClaimContextsArr
                cotVc.ClaimsArr1 = ClaimsArr
                cotVc.oMaxNum =  o1Dic.value(forKey: "O1MaxNum") as! Int
                cotVc.oMinNum = o1Dic.value(forKey: "O1MinNum") as! Int
