...
class RecordController: ZYSWController {
    
    @IBOutlet weak var _collectionView: UICollectionView!
    public var _list:[ACRecordModel]! = [ACRecordModel]();
    ...
    */
    ...
    func UISet() {
        ...
        self.title = LocalizeEx("candy_record_title");
...
//        self.navigationItem.rightBarButtonItem = item;
        ...
        let list =  Mapper<ACRecordModel>().mapArray(JSONArray: arr)
        _list = list;
    ...
    func updateMode(mod:ACRecordListModel!,params:Dictionary<String,Any>!){
        ...
        debugPrint("hasMore:\(b)")
        self._collectionView.mj_footer.isHidden = !b
        self.reloadData();
    }
    
    //是否有更多页
    func hasMore(_ page:Int,_ mod:ACRecordListModel) -> Bool {
    ...
    func loadDataWithPage(page:NSInteger,view:UIView?,handler:@escaping(SFRequestCommonBlock)) -> Void {
        ...
        let action = "income/getRecordList";
        let pageStr = String.init(format: "%d", page);
        let params = self.params(page:pageStr);
        AlamofireModel().loadModelEx(path: action, type: HTTPMethod.get, parameters: params) { (bSuccess, response: DataResponse<ACRecordListModel>) in
...
extension RecordController:CommonDelegate {
...
extension RecordController:UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        return collectionView.ar_sizeForCell(withIdentifier: ACRecordCLCell.cellIdentifier(), indexPath: indexPath, fixedWidth: width, configuration: { (c) in
            
            let cell:ACRecordCLCell = c as! ACRecordCLCell;
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let row  = indexPath.row;
        let mod:ACRecordModel = _list[row];
