...
class NewTitleView: UICollectionReusableView {
    ...
    //MARK -- common
    public func fillCellWithMod(mod:Any!,type:NewTitleView.TitleCommonType,row:NSInteger,delegate:CommonDelegate?) -> Void {
        self.fillCellWithMod(mod: mod, type: type, row: row, delegate: delegate, bLast: false)
    }
    
    public func fillCellWithMod(mod:Any!,type:NewTitleView.TitleCommonType,row:NSInteger,delegate:CommonDelegate?,bLast:Bool) -> Void {
